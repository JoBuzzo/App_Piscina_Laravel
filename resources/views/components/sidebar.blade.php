<div id="drawer-disable-body-scrolling"
    ...
    <h5 id="drawer-disable-body-scrolling-label"
        ...
        @auth{{ auth()->user()->name }}@endauth @guest Faça seu Login @endguest
    </h5>
    <button type="button" data-drawer-hide="drawer-disable-body-scrolling" aria-controls="drawer-disable-body-scrolling"
        ...
        <ul class="space-y-2">
            ...
            <li>
                <button type="button"
                    ...
                    aria-controls="dropdown-reserva" data-collapse-toggle="dropdown-reserva">
                    ...
                    <span class="flex-1 ml-3 text-left whitespace-nowrap">Reservas</span>
                ...
                <ul id="dropdown-reserva" class="hidden py-2 space-y-2">
                    <li>
                        <a href="{{ route('reservas.create') }}"
                            ...
                            <span class="flex-1 ml-3 whitespace-nowrap">Adicionar Reserva</span>
                            <span
                                class="inline-flex items-center justify-center px-2 ml-3 text-sm font-medium text-gray-800 bg-gray-200 rounded-full dark:bg-gray-700 dark:text-gray-300">Add</span>
                        </a>
                    </li>
                    <li>
            ...
            <li>
                <button type="button"
                    class="flex items-center w-full p-2 text-base font-normal text-gray-900 transition duration-75 rounded-lg group hover:bg-gray-100 dark:text-white dark:hover:bg-gray-700"
                    aria-controls="dropdown-despesa" data-collapse-toggle="dropdown-despesa">
                    <svg class="flex-shrink-0 w-6 h-6 text-gray-500 transition duration-75 group-hover:text-gray-900 dark:text-gray-400 dark:group-hover:text-white"
                        xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5"
                        stroke="currentColor">
                        <path stroke-linecap="round" stroke-linejoin="round"
                    ...
                    <span class="flex-1 ml-3 text-left whitespace-nowrap">Despesas</span>
                    <svg class="w-6 h-6" fill="currentColor" viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg">
                        <path fill-rule="evenodd"
                            d="M5.293 7.293a1 1 0 011.414 0L10 10.586l3.293-3.293a1 1 0 111.414 1.414l-4 4a1 1 0 01-1.414 0l-4-4a1 1 0 010-1.414z"
                            clip-rule="evenodd"></path>
                ...
                <ul id="dropdown-despesa" class="hidden py-2 space-y-2">
                    <li>
                        <a href="{{ route('despesas.create') }}"
                            class="flex items-center w-full p-2 text-base font-normal text-gray-900 transition duration-75 rounded-lg pl-11 group hover:bg-gray-100 dark:text-white dark:hover:bg-gray-700">
                            <span class="flex-1 ml-3 whitespace-nowrap">Adicionar Despesa</span>
                            <span
                                class="inline-flex items-center justify-center px-2 ml-3 text-sm font-medium text-gray-800 bg-gray-200 rounded-full dark:bg-gray-700 dark:text-gray-300">Add</span>
                        </a>
                    </li>
